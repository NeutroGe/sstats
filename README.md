...
These are the same stats you can get from websites like op.gg or leagueofgraphs.com but it's automatically displayed on your screen when you start a game (you dont have to copy paste the player list into op.gg), and the stats displayed are always up to date.
